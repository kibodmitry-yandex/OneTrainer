...
class TrainConfig(BaseConfig):
    ...
    def default_values() -> 'TrainConfig':
        ...
        # GPU temperature control (not stored in resume policy file)
        data.append(("gpu_temp_control_enabled", True, bool, False))
        data.append(("gpu_temp_max", 70, int, False))
        data.append(("gpu_temp_cool_to", 60, int, False))
